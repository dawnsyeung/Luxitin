            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-center gap-3">
                <a
                  ...
                  className="inline-flex h-10 w-10 items-center justify-center rounded-xl border border-[color:var(--line)] bg-[color:var(--bg-elevated)] text-[color:var(--muted)] hover:text-[color:var(--fg)]"
                >
                  <svg
                    width="18"
                    height="18"
